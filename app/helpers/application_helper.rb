module ApplicationHelper
  ...
  def render_svg(name, options = {})
    ...
    options[:class] = options.fetch(:styles, "fill-current text-slate-500")
  ...
  def badge(text = nil, options = {}, &block)
    ...
    color = options.delete(:color) || "bg-slate-100 text-slate-800"
  ...
  def options_for_selections(selected_value = nil)
    options = {
      "prototype" => "Jumpstart › New Prototype › $10,000 › 1 month",
      "mvp" => "Jumpstart › New MVP › $27,500 › 3 months",
      "jumpstart" => "Jumpstart › Existing updates › $10,000 › 1 month",
      "install" => "Campfire › New Install › $1,000 › 1 week",
      "paywall" => "Campfire › New Paywall install › $3,000 › 2 weeks",
      "custom" => "Campfire › New Custom install › $10,000 › 1 month",
      "campfire" => "Campfire › Existing updates › $1,000 › 1 month",
    }

    options.map do |value, text|
      content_tag(:option, text, value: value, selected: (value == selected_value))
    end.join.html_safe
  end
end
